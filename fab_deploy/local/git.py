...
class AddGitRemote(Task):
    ...
    * **user_and_host**: The connection string for this remote. admin@10.0.1.1 for example. This should not include the path to the repo.  
...
class GitPush(Task):
    ...
    **branch**: The branch that you would like to push. If it is not provided 'master' will be used.
